...
## Implementation evidence through checkpoint 36
...
TUI connection identity/model-switch acceptance: `TUI-CONNECTION-IMPLEMENTATION.md` (checkpoint35). Checkpoint36 adds spending continuity across TUI replacement; classifier parse-failure accounting remains the next task.

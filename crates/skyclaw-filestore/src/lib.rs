//! SkyClaw Filestore crate
//!
//! Provides file storage backends for SkyClaw. Two backends are available:
//!
...
) -> Result<Box<dyn FileStore>, SkyclawError> {

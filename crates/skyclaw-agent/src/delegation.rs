...
impl SubAgent {
    ...
    pub fn start(&mut self) -> Result<(), SkyclawError> {
    ...
    /// Mark as completed.
    pub fn complete(&mut self) -> Result<(), SkyclawError> {
    ...
    /// Mark as failed.
    pub fn fail(&mut self) -> Result<(), SkyclawError> {
        if self.status != SubAgentStatus::Running {
            return Err(SkyclawError::Internal(format!(
    ...
    /// Mark as timed out.
    pub fn time_out(&mut self) -> Result<(), SkyclawError> {
        if self.status != SubAgentStatus::Running {
            return Err(SkyclawError::Internal(format!(
...
impl DelegationManager {
    ...
    pub fn register_spawn(&self) -> Result<usize, SkyclawError> {
    ...
    ) -> Result<Vec<SubAgent>, SkyclawError> {

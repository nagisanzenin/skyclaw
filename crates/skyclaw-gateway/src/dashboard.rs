...
<body>
  ...
  <p class="footer">SkyClaw Agent Runtime &mdash; Dashboard is read-only</p>
</body>
</html>"##,
...
mod tests {
    ...
    use skyclaw_test_utils::{MockChannel, MockMemory, MockProvider};
    ...
    fn test_state() -> Arc<AppState> {
        ...
        let tools: Vec<Arc<dyn skyclaw_core::Tool>> = Vec::new();
        ...
        let channel: Arc<dyn skyclaw_core::Channel> = Arc::new(MockChannel::new("telegram"));
        Arc::new(AppState {
    ...
    async fn dashboard_page_returns_200_with_html() {
        ...
        assert!(html.contains("SkyClaw Dashboard"));

#!/usr/bin/env python3
"""Paired closeout core regression study. See CLOSEOUT-DESIGN.md for scope/gates."""
...
def main():
 ...
 args=p.parse_args();corpus=Path(__file__).with_name('closeout-corpus.json');tasks=json.loads(corpus.read_text());assert len(tasks)==30
